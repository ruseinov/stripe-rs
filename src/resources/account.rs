...
/// An enum representing the possible values of an `AccountCapabilities`'s `jcb_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
/// An enum representing the possible values of an `AccountCapabilities`'s `tax_reporting_us_1099_k` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
/// An enum representing the possible values of an `AccountCapabilities`'s `tax_reporting_us_1099_misc` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
