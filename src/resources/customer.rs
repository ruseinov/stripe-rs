...
impl TaxIdDataType {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            TaxIdDataType::BrCnpj => "br_cnpj",
            TaxIdDataType::BrCpf => "br_cpf",
            TaxIdDataType::CaBn => "ca_bn",
            TaxIdDataType::CaQst => "ca_qst",
            TaxIdDataType::ChVat => "ch_vat",
            TaxIdDataType::EsCif => "es_cif",
            TaxIdDataType::EuVat => "eu_vat",
            TaxIdDataType::HkBr => "hk_br",
            TaxIdDataType::InGst => "in_gst",
            TaxIdDataType::JpCn => "jp_cn",
            TaxIdDataType::KrBrn => "kr_brn",
            TaxIdDataType::LiUid => "li_uid",
            TaxIdDataType::MxRfc => "mx_rfc",
            TaxIdDataType::MyItn => "my_itn",
            TaxIdDataType::MySst => "my_sst",
            TaxIdDataType::NoVat => "no_vat",
            TaxIdDataType::NzGst => "nz_gst",
            TaxIdDataType::RuInn => "ru_inn",
            TaxIdDataType::SgGst => "sg_gst",
            TaxIdDataType::SgUen => "sg_uen",
            TaxIdDataType::ThVat => "th_vat",
            TaxIdDataType::TwVat => "tw_vat",
            TaxIdDataType::UsEin => "us_ein",
