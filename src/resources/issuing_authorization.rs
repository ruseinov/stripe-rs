...
/// An enum representing the possible values of an `IssuingAuthorizationVerificationData`'s `address_postal_code_check` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl IssuingAuthorizationVerificationDataAddressPostalCodeCheck {
    pub fn as_str(self) -> &'static str {
        match self {
            IssuingAuthorizationVerificationDataAddressPostalCodeCheck::Match => "match",
            IssuingAuthorizationVerificationDataAddressPostalCodeCheck::Mismatch => "mismatch",
...
/// An enum representing the possible values of an `IssuingAuthorizationVerificationData`'s `expiry_check` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl IssuingAuthorizationVerificationDataExpiryCheck {
    pub fn as_str(self) -> &'static str {
        match self {
            IssuingAuthorizationVerificationDataExpiryCheck::Match => "match",
            IssuingAuthorizationVerificationDataExpiryCheck::Mismatch => "mismatch",
            IssuingAuthorizationVerificationDataExpiryCheck::NotProvided => "not_provided",
        }
    }
}
